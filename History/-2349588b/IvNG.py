...
def show_images():
    ...
    new_img1.paste(img1, ((280 - img1.width), (600 - img1.height) ))
    new_img2.paste(img2, ((280 - img2.width), (600 - img2.height) ))
...
root.minsize(600, 600)  # Set the minimum size of the window
root.maxsize(600, 600)  # Set the maximum size of the window
