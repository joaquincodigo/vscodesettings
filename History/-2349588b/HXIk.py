...
def show_images():
    ...
    # Resize images to fit within 600x600 while maintaining aspect ratio
    ...
    new_img1.paste(img1, ((600 - img1.width) // 2, (600 - img1.height) // 2))
    new_img2.paste(img2, ((600 - img2.width) // 2, (600 - img2.height) // 2))
...
# Positioning the canvas widgets with a 30-pixel gap between them
