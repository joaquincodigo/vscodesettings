	...
	return (
		<div className="card">
			...
			<div className="card-description-container">
				...
				<div className="card-description-buttom-container">
					<button className='card-description-buttonup'>UP</button>
					<button className='card-description-buttondown'>DOWN</button>
				</div>
			</div>
		</div >
	);
