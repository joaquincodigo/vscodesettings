window.addEventListener("load", () => {
  ...
  function spawnNewFruit() {
    ...
    FRUIT_CELL.x = getRandomNumber(1, GRID_DIMENTIONS.x - 1); //We have to exclude walls
    FRUIT_CELL.y = getRandomNumber(1, GRID_DIMENTIONS.y - 1); //We have to exclude walls

    let oldFruit = document.getElementById(`${bodyChunk.x},${bodyChunk.y}`);
