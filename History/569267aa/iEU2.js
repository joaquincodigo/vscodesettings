  ...
  return (
    <div className="bg-pink-300 flex flex-col w-100">
      ...
      <img
        ...
        alt="Weather Icon"
      />
      <div className="w-full text-center capitalize bg-green-500">{weatherData.weather}</div>
      <div className="w-full text-center text-4xl bg-yellow-400">{weatherData.temperature} °C</div>
      <div className="w-full text-center text-2xl bg-slate-400">Feels like {weatherData.feelsLike} °C</div>
