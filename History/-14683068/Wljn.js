      ...
      >
        ...
        <ul className="flex flex-col mx-auto w-max gap-y-6">
          <li onClick={closeDrawer}>
            <Link className="flex" href="/my-recipes">
              <LuCookingPot className="mr-2 relative top-[+1px]"/>
          ...
          <li onClick={closeDrawer}>
            <Link className="flex" href="/settings">
              <GoGear className="mr-2 relative top-[+1px]"/>
              <p className="inline font-semibold">Settings</p>
            </Link>
          </li>
          <li onClick={closeDrawer}>
            <Link className="flex" href="/CHANGE_MEEEEEEEEEE">
              <IoIosLogOut className="mr-2 relative top-[+1px]"/>
