...
class ChessPuzzleVisualizer:
    def __init__(self, window_size=600):
        ...
        self.animation_speed = 60  # Reduced from 30 to 15 frames per move
 ...
 class ChessPuzzleVisualizer:
    ...
    def animate_move(self, board, move):
        """Animate a chess piece moving from one square to another with immediate capture."""
        ...
        # If there's a piece at the destination, remove it immediately (handle capture)
        ...
        for frame in range(self.animation_speed + 10):
            ...
            # Draw the current board state without the moving piece
